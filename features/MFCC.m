...
%     n = length(s);                                       % WARNING!!! full length
...
%    [z,tc]=enframe(s,hamming(n),inc);
   [z,tc]=enframe(s,0.54-0.46*cos(2*pi*(0:n-1)'/(n-1)),inc); % Hamming window //////    'M'
end
f=rfft(z.');
